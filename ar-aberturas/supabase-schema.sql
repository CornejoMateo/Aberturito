...
create table if not exists public.gallery_images_accesories (
  ...
  image_url character varying not null,
  public_id character varying not null,
  constraint gallery_images_accesories_pkey primary key (id),
  constraint unique_code_line_category_brand unique (name_category, name_code, name_brand, name_line)
) TABLESPACE pg_default;

create table public.gallery_images_ironworks (
  id bigint generated by default as identity not null,
  created_at timestamp with time zone not null default now(),
  name_category character varying not null,
  name_line character varying not null,
  ...
  image_url character varying not null,
  public_id character varying not null,
  constraint gallery_images_ironworks_pkey primary key (id),
  constraint unique_code_line_category_brand_iron unique (name_category, name_code, name_brand, name_line)
) TABLESPACE pg_default;

create table public.gallery_images_supplies (
  id bigint generated by default as identity not null,
  created_at timestamp with time zone not null default now(),
  name_category character varying not null,
  name_line character varying not null,
  ...
  image_url character varying not null,
  public_id character varying not null,
  constraint gallery_images_supplies_pkey primary key (id),
  constraint unique_code_line_category_brand_supply unique (name_category, name_code, name_brand, name_line)
) TABLESPACE pg_default;
