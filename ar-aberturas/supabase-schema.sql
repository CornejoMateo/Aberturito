...
create table public.dates (
  ...
  constraint dates_date_key unique (date)
) TABLESPACE pg_default;
...
create table public.events (
  ...
  work_id character varying null,
  constraint events_pkey primary key (id),
  constraint events_date_id_fkey foreign KEY (date_id) references dates (id) on update CASCADE
) TABLESPACE pg_default;
